...
export default function App() {
  ...
  const programs = [
    ...
    // {
    //   name: "Premiere Pro",
    //   text: "احترف المونتاج والإخراج السينمائي وإضافة المؤثرات الصوتية والبصرية",
    //   img: "https://upload.wikimedia.org/wikipedia/commons/4/48/Adobe_Premiere_Pro_CC_icon.svg",
  ...
  return (
    <div className="font-sans bg-gradient-to-b from-gray-50 to-white text-neutral-800 overflow-x-hidden" dir="rtl">
      {/* Enhanced Navbar */}
      <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6">
          ...
          <div className="hidden md:flex gap-8 text-sm font-medium">
            {["عن الأكاديمية", "البرامج", "المميزات", "تواصل معنا"].map((item, i) => (
              <Link
                ...
                smooth={true}
                duration={600}
                className="cursor-pointer text-gray-700 hover:text-blue-600 transition-colors relative group"
              >
                {item}
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="hidden md:flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-5 py-2.5 rounded-full shadow-lg hover:shadow-xl transition-shadow"
          >
            <span>سجل الآن</span>
            <span>←</span>
          </motion.a>
          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="flex flex-col gap-4 p-6">
                ...
                <a
                  href="https://wa.me/201555441846"
                  className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-5 py-2.5 rounded-full text-center"
                >
                  سجل الآن
                </a>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">
                ...
                <br />
                <span className="text-gray-800">بوابتك للاحتراف</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-8 py-4 rounded-2xl shadow-xl hover:shadow-2xl transition-all font-medium"
                >
                ...
                <div className="relative bg-white rounded-3xl shadow-2xl p-8">
                  <div className="grid grid-cols-2 gap-4">
                    {programs.map((program, i) => (
                      <motion.div
                        ...
                        className="flex flex-col items-center justify-center p-4 bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-100"
                      >
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-100">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">مدة الدبلومة</span>
                      <span className="font-bold text-blue-600">3 شهور</span>
                    </div>
                    <div className="flex justify-between items-center mt-2">
                      <span className="text-gray-600">عدد المحاضرات</span>
                      <span className="font-bold text-blue-600">48 محاضرة</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              ...
              >
                <div className={`${feature.iconBg} w-14 h-14 rounded-2xl flex items-center justify-center text-2xl mb-4 group-hover:scale-110 transition-transform`}>
                  {feature.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {programs.map((program, i) => (
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${program.gradient} opacity-5 group-hover:opacity-10 transition-opacity`}></div>
                <div className="relative p-8">
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1">
                      <h3 className="text-2xl font-bold mb-3 text-gray-800">{program.name}</h3>
                      <p className="text-gray-600 mb-4 leading-relaxed">{program.text}</p>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 text-white relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
          ...
          <div className="absolute bottom-10 right-10 w-96 h-96 bg-purple-400/20 rounded-full blur-3xl animate-pulse animation-delay-2000"></div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-5xl font-bold mb-4">دبلومة الميني جرافيك</h2>
            <p className="text-blue-100 text-lg max-w-3xl mx-auto">
              رحلتك المكثفة نحو احتراف التصميم الجرافيكي في 3 شهور فقط
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            >
                ...
                <div className="space-y-4">
                  {[
                    ...
                    >
                      ...
                      <span className="text-blue-200 text-sm">{item.hours}</span>
                    </motion.div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    { label: "مشاريع عملية", value: "12+", icon: "💼" },
                    { label: "ساعات تدريب", value: "72", icon: "⏱️" },
                    { label: "محاضرات", value: "48", icon: "📖" },
                    { label: "شهادة معتمدة", value: "✓", icon: "🏆" },
                  ].map((stat, i) => (
            ...
            >
              <div className="bg-white rounded-3xl p-8 shadow-2xl">
                ...
                <div className="space-y-3">
                  <motion.a
                    href="https://wa.me/201555441846?text=مرحباً، أريد التسجيل في دبلومة الميني جرافيك"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="block w-full bg-gradient-to-r from-green-500 to-green-600 text-white py-4 rounded-2xl font-bold text-center shadow-lg hover:shadow-xl transition-all"
                  >
                    سجل عبر واتساب 📱
                  </motion.a>
                  <motion.a
                    ...
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="block w-full bg-blue-600 text-white py-4 rounded-2xl font-bold text-center shadow-lg hover:shadow-xl transition-all"
                  >
                    اتصل الآن 📞
                  </motion.a>
                </div>
      ...
      <section className="py-20 bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900 text-white relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
          ...
          <div className="absolute bottom-20 left-20 w-96 h-96 bg-blue-500/20 rounded-full blur-3xl animate-pulse animation-delay-2000"></div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-yellow-400 to-amber-500 text-gray-900 px-4 py-2 rounded-full text-sm font-bold mb-4">
              <span>⭐</span>
              البرنامج الأشمل والأقوى
              <span>⭐</span>
            </div>
            <h2 className="text-5xl font-bold mb-4">دبلومة الميجا جرافيك</h2>
            <p className="text-purple-100 text-lg max-w-3xl mx-auto">
              البرنامج الأكثر شمولاً - احترف جميع مجالات التصميم والموشن جرافيك في 6 شهور
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-purple-300/30">
                <h3 className="text-2xl font-bold mb-6 flex items-center gap-2">
                  <span className="text-3xl">🚀</span>
                  محتوى شامل ومتقدم
                </h3>
                <div className="space-y-4">
                  {[
                    ...
                    <motion.div
                      ...
                      whileInView={{ opacity: 1, x: 0 }}
                      transition={{ delay: i * 0.1 }}
                      className="flex items-center justify-between bg-white/5 rounded-xl p-4 hover:bg-white/10 transition-all group"
                    >
                      <div className="flex items-center gap-3">
                        <span className="text-2xl group-hover:scale-110 transition-transform">{item.icon}</span>
                        <div>
                          <div className="font-medium">{item.program}</div>
                          <div className="text-xs text-purple-200">{item.level}</div>
                        </div>
                      </div>
                      <span className="text-purple-200 text-sm font-semibold">{item.hours}</span>
                    </motion.div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-purple-300/30">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    { label: "مشاريع متقدمة", value: "25+", icon: "💼" },
                    { label: "ساعات تدريب", value: "164", icon: "⏱️" },
                    { label: "محاضرات", value: "96", icon: "📖" },
                    { label: "جلسات فردية", value: "6", icon: "👨‍🏫" },
                  ].map((stat, i) => (
            ...
            >
              <div className="bg-white rounded-3xl p-8 shadow-2xl border-4 border-yellow-400">
                ...
                <div className="space-y-3">
                  <motion.a
                    href="https://wa.me/201555441846?text=مرحباً، أريد التسجيل في دبلومة الميجا جرافيك"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="block w-full bg-gradient-to-r from-green-500 to-green-600 text-white py-4 rounded-2xl font-bold text-center shadow-lg hover:shadow-xl transition-all"
                  >
                  ...
                  <motion.a
                    ...
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="block w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-4 rounded-2xl font-bold text-center shadow-lg hover:shadow-xl transition-all"
                  >
                    اتصل للاستفسار 📞
                  </motion.a>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-6 text-white">
                  ...
                  <div className="font-bold mb-1">تقسيط مريح</div>
                  <div className="text-green-100 text-sm">بدون فوائد على 6 أشهر</div>
                </div>
                <div className="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl p-6 text-white">
                  <div className="text-3xl mb-2">🎓</div>
                  <div className="font-bold mb-1">ضمان التوظيف</div>
                  <div className="text-blue-100 text-sm">دعم كامل حتى تجد عمل</div>
                </div>
              </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-600 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-bold mb-4">رحلتك التعليمية</h2>
            ...
            {[
              ...
              >
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all">
                  <div className="text-blue-200 text-sm font-medium mb-2">{step.month}</div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              اكتشف كيف غيرت دبلومة الميني جرافيك حياة المئات من خريجينا
            </p>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-8">
            {[
              { name: "أحمد محمد", role: "Graphic Designer", company: "شركة تقنية", text: "الدبلومة غيرت حياتي المهنية بالكامل، الآن أعمل في شركة أحلامي" },
              { name: "فاطمة علي", role: "Motion Designer", company: "وكالة إعلانية", text: "المحتوى العملي والمشاريع الحقيقية ساعدتني في بناء portfolio قوي" },
              { name: "محمد سالم", role: "Freelancer", company: "عمل حر", text: "بعد التخرج مباشرة بدأت العمل الحر وحققت دخل ممتاز" },
            ].map((testimonial, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, scale: 0.9 }}
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
              ...
              {/* <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 mb-8">
                <div className="grid md:grid-cols-3 gap-4 text-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600 text-sm">خصم حصري</div>
                  </div>
                  <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-green-500 to-green-600 text-white px-8 py-4 rounded-2xl shadow-xl hover:shadow-2xl transition-all font-medium"
                >
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center justify-center gap-2 bg-white text-blue-600 border-2 border-blue-200 px-8 py-4 rounded-2xl hover:bg-blue-50 transition-all font-medium"
                >
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
